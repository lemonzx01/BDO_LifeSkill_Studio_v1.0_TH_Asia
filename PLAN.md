...
| 4 · กิล | แท็บ "ราชวัง" (กล่องอาหาร/แปรธาตุราชวัง 389 กล่อง ราคาส่ง NPC + โบนัส Mastery ไม่หักภาษี) · หน้า `/plans` แผนกิล (บันทึกจากแผนผลิต ทุกคนเห็น ลบของตัวเอง/แอดมินลบได้) · ส่งออก CSV ตารางกำไร · นำเข้า/ส่งออก CSV คลังของ · PWA (manifest + ไอคอน เพิ่มลงหน้าจอมือถือได้) | ✅ ใช้งานได้ |
